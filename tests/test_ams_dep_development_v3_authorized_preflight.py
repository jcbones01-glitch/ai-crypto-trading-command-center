...
def _authorized_manifest(candidate):
    return {
        "status": "AUTHORIZED_FOR_FIRST_DEVELOPMENT_V3_EXECUTION",
...
def test_exact_authorized_v3_contract_passes(monkeypatch):
    candidate = "a" * 40
    executing = "b" * 40
    _install(
        monkeypatch,
...
def test_mutable_v3_governance_cannot_rebind_reviewed_candidate(monkeypatch):
